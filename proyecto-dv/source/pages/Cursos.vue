...
export default {
  ...
  // Llama a cargarProductos cuando el componente se monta
  mounted() {
  ...
  <section>
    <div class="pb-64 bg-gray-100">
      <div class="max-w-7xl px-4 pt-20 mx-auto text-center sm:text-left">
        ...
        <p class="mb-10 text-lg text-gray-600 md:text-xl">Busca tu curso ideal, resérvalo y nos pondremos en contacto para brindarte más información. </p>
      </div>
    </div>
