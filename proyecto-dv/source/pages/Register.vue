  ...
  <div class="container mx-auto px-4 py-8">
    ...
    <form action="#" @submit.prevent="handleSubmit">
      <div class="mb-4">
        ...
        <input type="email" id="email" v-model="newUser.email" class="w-full px-4 py-2 border rounded-md">
      </div>
      <div class="mb-4">
        <label for="password" class="block font-bold mb-2">Contraseña</label>
        <input type="password" id="password" v-model="newUser.password"  class="w-full px-4 py-2 border rounded-md">
      </div>
